...
import gradientBackground from '../assets/gradientBackground.png'; // adjust path as needed
...
const Hero = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center bg-cover bg-no-repeat min-h-screen'
