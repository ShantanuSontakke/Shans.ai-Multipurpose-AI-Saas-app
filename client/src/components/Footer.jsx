  ...
  return (
   ...
   mt-20">
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
       ...
       hover:text-primary transition-colors'>Shans.ai</h1>
            <p className="mt-6 text-sm">
                Exprience the power of AI with Shans.ai.<br/>Transform your content creation with our suite of premium AI tools.<br/> Write articles, generate images, and enhance your workflow. 
            </p>
        </div>
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 © Shans.ai. All Right Reserved.
    </p>
</footer>
  )
}
